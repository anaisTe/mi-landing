...
(function () {
    ...
    var metLightbox = {
        ...
        capturaImagen: function () {
            ...
            propLightbox.cuerpoDom.style.overflowY = "hidden";
        },
        lightbox: function (imagen) {
            ...
            document.getElementById('modal').setAttribute('class','modal-box');

            propLightbox.modal = document.getElementById('modal');
            propLightbox.modal.innerHTML += '<i id="cerrar_modal" class="material-icons-round custom-icon">highlight_off</i>';
        ...
        cerrarModal: function () {
            ...
            propLightbox.cuerpoDom.style.overflowY = "visible";
        }
    };
